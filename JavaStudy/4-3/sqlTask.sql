...
-- [回答]
 SELECT store_nameAbc FROM store_table order by store_nameAbc asc
...
-- [回答]
SELECT “店舗名” ,goods_name,quantity FROM stock_table
INNER JOIN goods_table_ON stock_table.goods_code = goods_table.goods_code
INNER JOIN store_table ON stock_table.goods_code = store_table/store_code
